...
def save_image(request):
	if request:
		...
		# return the URL
		actual(request)
		return HttpResponse('http://localhost:8000/media/output2.jpg')
	else:
...
def actual(request):
	...
	cv2.imwrite(settings.MEDIA_ROOT+'/output2.jpg', output_im)
	image_data = open('output2.jpg', "rb").read()
